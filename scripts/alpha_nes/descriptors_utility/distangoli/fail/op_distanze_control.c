...
fclose(file_alldes);
  ...
  for (i=0;i<num;i++)
  {
    ...
    for (li=0;li<l;li++)
    {
      fprintf(file_derivate_angolari,",%14.11g,%14.11g",da[i][li].dxij*3.,da[i][li].dxik*3.);
    }
    while (li++<expected)
    ...
    for (li=0;li<l;li++)
    {
      fprintf(file_derivate_angolari,",%14.11g,%14.11g",da[i][li].dyij*3.,da[i][li].dyik*3.);
    }
    while (li++<expected)
      fprintf(file_derivate_angolari,",0.,0.");
    ...
    for (li=0;li<l;li++)
    {
      fprintf(file_derivate_angolari,",%14.11g,%14.11g",da[i][li].dzij*3.,da[i][li].dzik*3.);
    }
    while (li++<expected)
      fprintf(file_derivate_angolari,",0.,0.");
  ...
  for (i=0;i<num;i++)
  {
    ...
    for (li=0;li<l;li++)
    {
      ...
      fprintf(file_derivate,",%14.11g",d*3.);
    }
    while (li++<expected)
