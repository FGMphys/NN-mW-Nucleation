...
int main(int argc,char *argv[])
{
 ...
 /////////////////////////////////////////////////
  ...
  for (i=0;i<num;i++)
  {
    ...
    for (li=1;li<l;li++)
    {
      d=-0.5*sin(pi*ds[i][li].dist/range)*pi/range*ds[i][li].dx/ds[i][li].dist;
      fprintf(file_derivate,",%14.11g",d);
    }
    while (li++<expected)
   ...
   d=-0.5*sin(pi*ds[i][0].dist/range)*pi/range*ds[i][0].dy/ds[i][0].dist;
      fprintf(file_derivate,"%14.11g",d);

    for (li=1;li<l;li++)
    {
      d=-0.5*sin(pi*ds[i][li].dist/range)*pi/range*ds[i][li].dy/ds[i][li].dist;
      fprintf(file_derivate,",%14.11g",d);
    }
    while (li++<expected)
      fprintf(file_derivate,",0.");
    ...
    // stampa derivate y
     ...
     d=-0.5*sin(pi*ds[i][0].dist/range)*pi/range*ds[i][0].dz/ds[i][0].dist;
      fprintf(file_derivate,"%14.11g",d);
    for (li=1;li<l;li++)
    {
     d=-0.5*sin(pi*ds[i][li].dist/range)*pi/range*ds[i][li].dz/ds[i][li].dist;
      fprintf(file_derivate,",%14.11g",d);
    }
    while (li++<expected)
      fprintf(file_derivate,",0.");
 ...
 ////////////DERIVATE DI SUPPORTO 3BODY/////////////////////////////////
  ...
  for (i=0;i<num;i++)
  {
    ...
    for (li=1;li<l;li++)
    {
      d=-0.5*sin(pi*ds[i][li].dist/range_angolare)*pi/range_angolare*ds[i][li].dx/ds[i][li].dist;
      fprintf(file_der3b_supp,",%14.11g",d);
    }
    while (li++<expected)
   ...
   d=-0.5*sin(pi*ds[i][0].dist/range_angolare)*pi/range_angolare*ds[i][0].dy/ds[i][0].dist;
      fprintf(file_der3b_supp,"%14.11g",d);

    for (li=1;li<l;li++)
    {
      d=-0.5*sin(pi*ds[i][li].dist/range_angolare)*pi/range_angolare*ds[i][li].dy/ds[i][li].dist;
      fprintf(file_der3b_supp,",%14.11g",d);
    }
    while (li++<expected)
      fprintf(file_der3b_supp,",0.");
    ...
    // stampa derivate y
     ...
     d=-0.5*sin(pi*ds[i][0].dist/range_angolare)*pi/range_angolare*ds[i][0].dz/ds[i][0].dist;
      fprintf(file_der3b_supp,"%14.11g",d);
    for (li=1;li<l;li++)
    {
     d=-0.5*sin(pi*ds[i][li].dist/range_angolare)*pi/range_angolare*ds[i][li].dz/ds[i][li].dist;
      fprintf(file_der3b_supp,",%14.11g",d);
    }
    while (li++<expected)
      fprintf(file_der3b_supp,",0.");
