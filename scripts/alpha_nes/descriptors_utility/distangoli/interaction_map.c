...
{
	interactionmap *i=(interactionmap*)malloc(sizeof(interactionmap));;

	i->num=0;
	i->who=(int*)calloc(max_elements,sizeof(int));
	i->howmany=(int*)calloc(max_elements,sizeof(int));
	i->size=max_elements;
	i->num_bonds=0;
...
{
	threebodyim *i=(threebodyim*)malloc(sizeof(threebodyim));;
